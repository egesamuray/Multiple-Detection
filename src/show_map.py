...
A = io.loadmat('mapping_resultBtoA_gradient.mat', squeeze_me=True)
...
plt.figure()
im = plt.imshow((original), vmin=-.5, vmax=.5, aspect='auto', cmap="Greys", interpolation="lanczos")
...
plt.figure()
im = plt.imshow((result), vmin=-.5, vmax=.5, aspect='auto', cmap="Greys", interpolation="lanczos")
...
plt.figure()
im = plt.imshow((masked), vmin=-.5, vmax=.5, aspect='auto', cmap="Greys", interpolation="lanczos")
...
plt.figure()
im = plt.imshow((original-result), vmin=-.5, vmax=.5, aspect='auto', cmap="Greys", interpolation="lanczos")
