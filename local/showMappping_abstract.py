...
image = data_train[test_num,:,:,0]*np.linalg.norm(prim[2*test_num+1, :, :].reshape(-1), np.inf)
if data_train.shape[-1] > 1:
    image_mult = data_train[test_num,:,:,1]*np.linalg.norm(mul[2*test_num+1, :, :].reshape(-1), np.inf)
else:
    image_mult = np.zeros(image.shape)

imageA = data_trainA[test_num,:,:,0]*np.linalg.norm(prim[2*test_num+1, :, :].reshape(-1), np.inf)
imageA_mult = data_trainA[test_num,:,:,1]*np.linalg.norm(mul[2*test_num+1, :, :].reshape(-1), np.inf)
imageB = data_trainB[test_num,:,:, 0]*np.linalg.norm(recon[2*test_num+1, :, :].reshape(-1), np.inf)
imageB_mult = data_trainB[test_num,:,:, 1]*np.linalg.norm(srmemult[2*test_num+1, :, :].reshape(-1), np.inf)
...
Xstart= (imageA.shape[1]-(2*test_num+1)) * dx
X0 = (-(2*test_num+1) + 1) * dx
...
plt.plot(np.arange(175, 175+250, 1)*dt, imageA[175:175+250, 2*test_num+1 + 12],linewidth=1.5, \
    label="Multiple elimination - EPSI", color='#00c292')
plt.plot(np.arange(175, 175+250, 1)*dt, image[175:175+250, 2*test_num+1 + 12], linewidth=1.5, \
...
if exp=='exp-2':
    ...
    # plt.figure(dpi=150, figsize=(12, 4)); 
    # plt.plot(np.arange(175, 175+250, 1)*dt, imageB[175:175+250, 2*test_num+1 + 12], linewidth=1.5, \
    ...
    plt.figure(dpi=150, figsize=(12, 4)); 
    plt.plot(np.arange(175, 175+250, 1)*dt, imageB_mult[175:175+250, 2*test_num+1 + 12], linewidth=1.5, \
...
plt.figure(dpi=150, figsize=(12, 4)); 
plt.plot(np.arange(175, 175+250, 1)*dt, imageA_mult[175:175+250, 2*test_num+1 + 12], linewidth=1.5, \
    label="Predicted multiples - EPSI", color='#3f3f3f')
if data_train.shape[-1] > 1:
    plt.plot(np.arange(175, 175+250, 1)*dt, image_mult[175:175+250, 2*test_num+1 + 12], linewidth=1.5, \
...
plt.figure(dpi=150, figsize=(12, 4)); 
plt.plot(np.arange(1024-250, 1024, 1)*dt, imageA[-250:, 2*test_num+1 + 12],linewidth=1.5, \
    label="Multiple elimination - EPSI", color='#4057e8')
plt.plot(np.arange(1024-250, 1024, 1)*dt, image[-250:, 2*test_num+1 + 12], linewidth=1.5, \
...
if exp=='exp-2':
    # plt.figure(dpi=150, figsize=(12, 4)); 
    # plt.plot(np.arange(1024-250, 1024, 1)*dt, imageB[-250:, 2*test_num+1 + 12], linewidth=1.5, \
    #     label="w/ multiples", color='#03a9f3')
    ...
    plt.figure(dpi=150, figsize=(12, 4)); 
    plt.plot(np.arange(1024-250, 1024, 1)*dt, imageB_mult[-250:, 2*test_num+1 + 12], linewidth=1.5, \
        label="Unadapted multiples", color='#A569BD')
    # plt.title('Predicted multiples')
    plt.xlabel('Time (s)')
    plt.legend(loc='upper right')
...
plt.figure(dpi=150, figsize=(12, 4)); 
plt.plot(np.arange(1024-250, 1024, 1)*dt, imageA_mult[-250:, 2*test_num+1 + 12], linewidth=1.5, \
    label="Adapted multiples - EPSI", color='#3f3f3f')
if data_train.shape[-1] > 1:
    plt.plot(np.arange(1024-250, 1024, 1)*dt, image_mult[-250:, 2*test_num+1 + 12], linewidth=1.5, \
        label="Adapted multiples - CNN", color='#d1c70e')
# plt.title('Predicted multiples')
plt.xlabel('Time (s)')
plt.legend(loc='upper right')
