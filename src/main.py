...
parser.add_argument('--dataset_dir', dest='dataset_dir', default='multiple', help='path of the dataset')
...
parser.add_argument('--image_size0', dest='image_size0', type=int, default=1024, help='then crop to this size')
...
parser.add_argument('--L1_lambda', dest='L1_lambda', type=float, default=1500.0, help='weight on L1 term in objective')
...
parser.add_argument('--test_case', dest='test_case', type=int, default=100, help='test data number')
