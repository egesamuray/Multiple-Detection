...
parser.add_argument('--data_path', dest='data_path', type=str, \
	default='/data/NelsonData/hdf5', help='path to Nelson data')
parser.add_argument('--save_path', dest='save_path', type=str, \
	default='/data/NelsonData/trainingData_poorPrediction_divide', help='path to save data')
...
k = 0
for i in range(0, ceil(prim.shape[0]/2), 1):
...
k = 0
for i in range(ceil(prim.shape[0]/2), prim.shape[0], 1):
